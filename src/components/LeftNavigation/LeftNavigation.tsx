...
interface LeftNavigationProps {
  pets: LeftNavigationPet[] | null; // Se puede poner null para el estado inicial
}
    ...
    <aside className="your-pets">
      <div className="pets-section">
        ...
        <h2 className="pets-title">
          {pets && pets.length > 0 ? `Your pets (${pets.length})` : "Loading your pets..."}
        </h2>
        <div className="pets-list">
          {pets && pets.length > 0 ? (
            ...
            <p className="no-pets-message">Espera, tus mascotas ya aparecerán.</p>
          )}
        </div>
      </div>
